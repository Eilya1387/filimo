const Footer = () => {
  return (
    <>
      <footer className="hidden md:flex z-21 text-[12px] font-bold items-center w-full h-9 bg-[#151515] fixed bottom-0 justify-center text-white">
        <div className="flex items-center justify-between w-[90%]">
          <div className="relative group">
            <span className="item-head ">
              <i className="bi bi-caret-up-fill"></i> شبکه های اجتماعی
            </span>
            ...
            <ul className="bg-[#1e1e1e]  rounded-[10px] absolute bottom-5 p-5 w-40  flex flex-col justify-center items-end gap-3 text-center invisible group-hover:visible">
              <li className="item-ul">
                آپارات <i className="bi bi-camera-reels"></i>
              </li>
              <li className="item-ul">
                تلگرام <i className="bi bi-telegram"></i>
              </li>
              <li className="item-ul">
                توییتر <i className="bi bi-twitter"></i>
              </li>
              <li className="item-ul">
                اینستاگرام <i className="bi bi-instagram"></i>
              </li>
            </ul>
          </div>
          <div className="flex items-center gap-5">
            <div className="item-head group relative">
              سایر لینک ها
            ...
            <div className="item-head">
              تماشا با تلویزیون <i className="bi bi-tv"></i>
            </div>
          </div>
        </div>
      </footer>
